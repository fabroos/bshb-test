...
export declare const ClientPump: <Queries extends PumpQuery[]>({ children, rawQueries, pumpEndpoint, pumpToken: initialPumpToken, initialState, initialResolvedChildren, apiVersion, }: {
