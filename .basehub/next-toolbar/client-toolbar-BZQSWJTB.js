...
// node_modules/.pnpm/basehub@7.0.3_@babel+runtime@7.24.7_@types+react@18.3.3_react-dom@19.0.0-rc-4c2e457c7c-202405_7se37b3ufix7zd7fh2zn5nnn7u/node_modules/basehub/src/next/toolbar/client-toolbar.tsx
import * as React4 from "react";

// esbuild-scss-modules-plugin:./toolbar.module.scss
var digest = "1accc691482fc4ff1a97b5cfc6cd2ee12a785b9b195b0b8ae7bbcf93b12bc8f6";
var classes = { "wrapper": "_wrapper_lled4_1", "branch": "_branch_lled4_32", "in": "_in_lled4_1", "root": "_root_lled4_53", "draft": "_draft_lled4_65", "breathe": "_breathe_lled4_1", "tooltipWrapper": "_tooltipWrapper_lled4_120", "tooltip": "_tooltip_lled4_120", "dragHandle": "_dragHandle_lled4_128", "dragging": "_dragging_lled4_132", "forceVisible": "_forceVisible_lled4_156", "top": "_top_lled4_159", "bottom": "_bottom_lled4_170", "right": "_right_lled4_180", "left": "_left_lled4_191" };
var css = `._wrapper_lled4_1 {
  box-sizing: border-box;
  font-size: 16px;
}
._wrapper_lled4_1 *,
._wrapper_lled4_1 *:before,
._wrapper_lled4_1 *:after {
  box-sizing: inherit;
}
._wrapper_lled4_1 h1,
._wrapper_lled4_1 h2,
...
._wrapper_lled4_1 {
  ...
  z-index: 1000;
  border-radius: 7px;
  animation: _in_lled4_1 0.3s ease-out;
  display: flex;
}
...
._root_lled4_53[data-draft-active=true] {
  border-color: #ff6c02;
  background-color: rgba(255, 108, 2, 0.15);
}
._root_lled4_53[data-draft-active=true]:has(button._draft_lled4_65:enabled:hover) {
  border-color: #ff8b35;
}
...
._draft_lled4_65:disabled:hover {
  cursor: not-allowed;
}
._draft_lled4_65[data-active=true] {
  border-color: #ff6c02;
}
._draft_lled4_65[data-active=true]:enabled:hover {
  border-color: #ff8b35;
  background-color: #ff8b35;
}
._draft_lled4_65[data-active=false] {
  border: 1px solid #303030;
}
._draft_lled4_65[data-active=false]:enabled:hover {
  background-color: #0c0c0c;
}
._draft_lled4_65:focus-visible {
  outline: 1px solid;
  outline-offset: -1px;
...
._draft_lled4_65[data-loading=false] ._draft_lled4_65[data-active=true] {
  transition: color 0.2s, background-color 0.2s;
}
._draft_lled4_65[data-loading=false] ._draft_lled4_65[data-active=true]:enabled:hover {
  color: #fff;
}
._draft_lled4_65[data-loading=true] {
  cursor: wait !important;
}
._draft_lled4_65[data-loading=true] svg {
  animation: _breathe_lled4_1 1s infinite;
}

._tooltipWrapper_lled4_120 {
  position: relative;
  display: flex;
}
._tooltipWrapper_lled4_120:hover ._tooltip_lled4_120 {
  visibility: visible;
}

._dragHandle_lled4_128 {
  all: unset;
  cursor: grab;
}
._dragHandle_lled4_128._dragging_lled4_132 {
  cursor: grabbing;
}
._dragHandle_lled4_128:active {
  cursor: grabbing;
}
...
._tooltip_lled4_120._forceVisible_lled4_156 {
  visibility: visible;
}
._tooltip_lled4_120._top_lled4_159 {
  top: 40px;
  bottom: unset;
  transform: translateY(0) translateX(var(--translate-x));
}
._tooltip_lled4_120._top_lled4_159:before {
...
._tooltip_lled4_120._bottom_lled4_170 {
  bottom: 40px;
  top: unset;
  transform: translateY(0) translateX(var(--translate-x));
}
._tooltip_lled4_120._bottom_lled4_170:before {
  bottom: -4.5px;
  top: unset;
  transform: translateX(0) rotate(45deg);
}
._tooltip_lled4_120._right_lled4_180 {
  right: 0;
  left: unset;
  transform: translateX(0);
  --translate-x: 0;
}
._tooltip_lled4_120._right_lled4_180:before {
  right: 8px;
  left: unset;
  transform: translateX(--translate-x) rotate(45deg);
}
._tooltip_lled4_120._left_lled4_191 {
  left: 50%;
  right: unset;
  transform: translateX(-50%);
  --translate-x: -50%;
}
._tooltip_lled4_120._left_lled4_191:before {
  left: 50%;
  right: unset;
  transform: translateX(-50%) rotate(45deg);
}
._tooltip_lled4_120:before {
  z-index: -1;
...
// node_modules/.pnpm/basehub@7.0.3_@babel+runtime@7.24.7_@types+react@18.3.3_react-dom@19.0.0-rc-4c2e457c7c-202405_7se37b3ufix7zd7fh2zn5nnn7u/node_modules/basehub/src/next/toolbar/components/tooltip.tsx
...
// node_modules/.pnpm/basehub@7.0.3_@babel+runtime@7.24.7_@types+react@18.3.3_react-dom@19.0.0-rc-4c2e457c7c-202405_7se37b3ufix7zd7fh2zn5nnn7u/node_modules/basehub/src/next/toolbar/components/drag-handle.tsx
...
// node_modules/.pnpm/basehub@7.0.3_@babel+runtime@7.24.7_@types+react@18.3.3_react-dom@19.0.0-rc-4c2e457c7c-202405_7se37b3ufix7zd7fh2zn5nnn7u/node_modules/basehub/src/next/toolbar/components/branch-swticher.tsx
import * as React3 from "react";
var BranchSwitcher = ({
  isForcedDraft,
  draft
}) => {
  return /* @__PURE__ */ React3.createElement("div", { className: toolbar_module_default.branch, "data-draft-active": isForcedDraft || draft }, /* @__PURE__ */ React3.createElement(BranchIcon, null), "\xA0main");
};
var BranchIcon = () => {
...
var ClientToolbar = ({
  ...
  const triggerDraftMode = React4.useCallback(
    (previewToken) => {
      setLoading(true);
      enableDraftMode(previewToken).then(({ status, response }) => {
        if (status === 200) {
  ...
  return /* @__PURE__ */ React4.createElement("div", { className: toolbar_module_default.wrapper, ref: (ref) => setToolbarRef(ref) }, /* @__PURE__ */ React4.createElement(
    DragHandle,
    {
      ref: dragHandleRef,
      onDrag: (pos) => {
    ...
    /* @__PURE__ */ React4.createElement("div", { className: toolbar_module_default.root, "data-draft-active": isForcedDraft || draft }, /* @__PURE__ */ React4.createElement(BranchSwitcher, { isForcedDraft, draft }), /* @__PURE__ */ React4.createElement(
      Tooltip,
      {
